...
const CarsMahindra = () => {
    const cars = [
        { name: 'Scorpio', price: '₹13.62 - 17.42 Lakh', image: 'Images/scorpio.webp', url: '' },
        { name: 'XUV 3XO', price: '₹6.13 - 10.15 Lakh', image: 'Images/xuv 3xo.webp', url: '' },
        { name: 'Thar.E', price: '₹11.35 - 17.60 Lakh', image: 'Images/thare.jpg', url: '' },
    ];
