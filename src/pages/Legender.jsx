        ...
        <Row className="align-items-center">
          ...
          <Col md={7} xs={12} className="p-4">
            <div className="car-info">
              <h2 className="car-title"> Fortuner Legender </h2>
              <p className="rating">
                <span className="stars">★★★★★</span> 590 Reviews
              </p>
              <p className="car-description">
            
The Toyota Fortuner Legender is a premium variant of the
 Toyota Fortuner, offering a more luxurious and stylish package.
  It's known for its bold and modern design enhancements, along with upgraded features,
  making it stand out from the standard Fortuner model.
              </p>
              <p className="price">51.65 Lakh - 56.35 Lakh</p>
      ...
      <Table className="spec-table">
        ...
        <tbody>
          <tr>
            <td>Engine Type</td>
            <td>  2.8-liter diesel engine with around 201 bhp and 500 Nm of torque.</td>
          </tr>
          <tr>
            <td>Seating Capacity</td>
            <td> 7 passengers with ample space.</td>
          </tr>
          <tr>
            <td>Transmission</td>
            <td>  both automatic and manual transmission .
          ...
          <tr>
            <td>Mileage</td>
            <td> 12 to 14 km/l for the 2.8L diesel engine.
            </td>
          </tr>
          <tr>
            <td>Price Range</td>
            <td>51.65 Lakh - 56.35 Lakh</td>
          </tr>
          <tr>
            <td>Safety rating</td>
            <td>7 airbags, ABS with EBD.</td>
          </tr>
          <tr>
            <td>Body style</td>
          ...
          <tr>
            <td>Acceleration</td>
            <td>0-100 km/h time of around 10 seconds.</td>
          </tr>
          <tr>
            <td>Top Speed</td>
            <td> 180-190 km/h </td>
          ...
          <tr>
            ...
            <td>Colors (Platinum White Pearl, Attitude Black, and Avant-Garde Bronze.)</td>
          </tr>
          <tr>
            <td>Other Feature</td>
            <td>Tyre Pressure Monitoring System (TPMS),rear parking sensors</td>
          </tr>
        </tbody>
      </Table>
