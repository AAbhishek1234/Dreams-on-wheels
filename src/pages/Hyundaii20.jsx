    ...
    <Container fluid className="car-details-container my-4">
        ...
        <Row className="align-items-center">
          ...
          <Col md={7} xs={12} className="p-4">
            <div className="car-info">
              <h2 className="car-title">Hyundai i20</h2>
              <p className="rating">
                <span className="stars">★★★★★</span> 570 Reviews
              </p>
              <p className="car-description">
              The Hyundai i20 is a popular subcompact hatchback, known for 
              its stylish design, solid build quality, and a good mix of features 
              and performance. It has undergone several updates over the years, and
               the most recent model (2023 onwards) continues to be available with 
               a range of engine options, modern tech, and premium features.
              </p>
              <p className="price">₹ 7.00 Lakh - 11.20 Lakh</p>
      ...
      <Table className="spec-table">
        ...
        <tbody>
          <tr>
            <td>Engine Type</td>
            <td>  1.2L 4-Cylinder Petrol Engine (NA)</td>
          </tr>
          <tr>
          ...
          <tr>
            <td>Mileage</td>
            <td> Around 16-18 km/l
            </td>
          </tr>
          <tr>
            <td>Price Range</td>
            <td> ₹ 7.00 Lakh - 11.00 Lakh</td>
          </tr>
          <tr>
            <td>Safety rating</td>
          ...
          <tr>
            <td>Acceleration</td>
            <td>Acceleration (0-100 km/h): Approximately 10-12 seconds</td>
          </tr>
          <tr>
            <td>Top Speed</td>
         ...
         <Col sm={12} md={6} lg={4}>
          <Card className="shadow-sm" style={{ height: '100%', display: 'flex', flexDirection: 'column' }}>
             ...
             <Card.Body className="d-flex flex-column">
               ...
               <Card.Text className="price">8.50 Lakh -11.31Lakh</Card.Text>
               <Button className="offer-button-custom" onClick={() => handleNavigate('/amaze')}>View Details</Button>
             </Card.Body>
           </Card>
         </Col>
         ...
         <Col sm={12} md={6} lg={4}>
           <Card className="shadow-sm" style={{ height: '100%', display: 'flex', flexDirection: 'column' }}>
             ...
             <Card.Body className="d-flex flex-column">
               ...
               <Card.Text className="price">08.67 Lakh - 15.10Lakh</Card.Text>
