        ...
        <Row className="align-items-center">
          ...
          <Col md={7} xs={12} className="p-4">
            <div className="car-info">
              <h2 className="car-title">MG Windsor EV </h2>
              <p className="rating">
                <span className="stars">★★★★★</span> 595 Reviews
              </p>
              <p className="car-description">
              The MG Windsor EV is a compact, purpose-built electric
               vehicle with a strong focus on family-oriented design and practicality.
               The Windsor EV boasts a unique aerodynamic, compact design with premium features like connected LED DRLs, flush door handles, and an illuminated MG logo.

              </p>
              <p className="price">15.70 Lakh - 18.10 Lakh</p>
