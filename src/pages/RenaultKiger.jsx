      ...
      <Container fluid className="car-details-container my-4">
          ...
          <Row className="align-items-center">
            ...
            <Col md={7} xs={12} className="p-4">
              <div className="car-info">
                <h2 className="car-title"> Renault Kiger </h2>
                <p className="rating">
                  <span className="stars">★★★★★</span> 500 Reviews
                </p>
                <p className="car-description">
                  The Renault Kiger is a subcompact SUV known for its sporty
                  design, practicality, and value-for-money features. It is
                  popular in markets like India and offers a mix of style,
                  comfort, and performance.
                </p>
                <p className="price">06.17 Lakh- 13.15 Lakh</p>
        ...
        <Table className="spec-table">
          ...
          <tbody>
            <tr>
              <td>Engine Type</td>
              <td>1.0L Turbocharged Petrol,1.0L Naturally Aspirated Petrol.</td>
            </tr>
            <tr>
            ...
            <tr>
              <td>Transmission</td>
              <td> 5-speed manual, AMT, and CVT.</td>
            </tr>
            <tr>
              <td>Fuel Type</td>
              <td> Petrol</td>
            ...
            <tr>
              ...
              <td>
                ...
                20.5 km/l (ARAI-certified),Turbocharged Petrol (1.0L) Manual
                Transmission: 20.0 km/l
              </td>
            </tr>
            <tr>
              <td>Price Range</td>
              <td>06.17 Lakh- 13.15 Lakh</td>
            </tr>
            <tr>
              <td>Safety rating</td>
              <td>
                Dual airbags as standard; higher variants offer side airbags.
              </td>
            </tr>
            <tr>
              <td>Body style</td>
            ...
            <tr>
              <td>Acceleration</td>
              <td>
                Turbocharged Engine: Achieves 0-100 km/h in approximately 10.1
                seconds. Naturally Aspirated Engine: Slightly slower, at around
                13 seconds.
              </td>
            </tr>
            <tr>
              <td>Top Speed</td>
              <td>
                Naturally Aspirated Engine: Approximately 160 km/h,Turbocharged
                Engine: Around 172 km/h.
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>
                Colors:Caspian Blue, Radiant Red, Ice Cool White, Mahogany
                Brown, Moonlight Silver, Planet Grey.
              </td>
            </tr>
            <tr>
              <td>Other Feature</td>
              <td>
              ISOFIX child-seat anchors,Ample cabin space with 405L of boot space.
              </td>
            </tr>
          </tbody>
        </Table>
