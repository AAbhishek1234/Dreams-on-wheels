        ...
        <Row className="align-items-center">
          ...
          <Col md={7} xs={12} className="p-4">
            <div className="car-info">
              <h2 className="car-title">Tata Curvv</h2>
              <p className="rating">
...
The Tata Curvv is an upcoming SUV concept by Tata Motors that 
combines futuristic design, electrification, and innovative features.
 It represents Tata's vision for the next generation of mobility and stands out as 
 a "Coupe-style SUV.
              </p>
      ...
      <Table className="spec-table">
        ...
        <tbody>
          ...
          <tr>
            <td>Mileage</td>
            <td>  400–500 km on a single charge,
            </td>
          </tr>
          <tr>
            <td>Price Range</td>
            <td>11.59 Lakh - 23.45 Lakh</td>
          </tr>
          <tr>
            <td>Safety rating</td>
          ...
          <tr>
            <td>Acceleration</td>
            <td>Acceleration (0-100 km/h): Approximately 06-08 seconds</td>
          </tr>
          <tr>
            <td>Top Speed</td>
            <td> 150–170 km/h  for EV and ICE versions.
            </td>
          </tr>
         
          <tr>
            <td>Available Colors</td>
            <td>4 Colors (green,grey, black, and white shades.)</td>
          </tr>
          <tr>
            <td>Other Feature</td>
